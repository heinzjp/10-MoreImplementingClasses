...
class Line(object):
    ...
    def line_plus(self, other_line):
        ...
        new_start = Point(self.start.x + other_line.start.x, self.start.y + other_line.start.y)
        new_end = Point(self.end.x + other_line.end.x, self.end.y + other_line.end.y)
    ...
    def midpoint(self):
        ...
        x_midpoint = (self.start.x + self.end.x) / 2
        y_midpoint = (self.start.y + self.end.y) / 2
        mid_point = Point(x_midpoint, y_midpoint)
        return mid_point
    ...
    def is_parallel(self, line2):
        ...
        a = round(self.slope(), 12)
        b = round(line2.slope(), 12)
